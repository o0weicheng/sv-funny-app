import { l as lifecycle_function_unavailable, e as derived, f as attributes, g as clsx, h as bind_props, p as props_id, j as attr, s as spread_props, k as stringify, m as ensure_array_like, n as element, o as attr_class, q as head } from "../../chunks/index.js";
import "clsx";
import { M as MediaQuery, d as defaultWindow, c as createSubscriber, w as watch, C as Context, b as boxWith, a as createBitsAttrs, g as getDataOpenClosed, e as attachRef, f as boolToEmptyStrOrUndef, S as SPACE, E as ENTER, h as createId, m as mergeProps, i as isBrowser, n as noop, j as isHTMLElement, k as getWindow, l as executeCallbacks, o as getDocument, p as isElement, q as isElementOrSVGElement, D as DOMContext, r as ESCAPE, s as simpleBox, t as composeHandlers, u as contains, v as SvelteMap, x as isIOS, y as boxFrom, z as cssToStyleObj, A as isNotNull, B as styleToString, F as isFocusVisible } from "../../chunks/create-id.js";
...
import { s as setContext, g as getContext, b as getAllContexts, e as escape_html } from "../../chunks/context.js";
                            ...
                            children: ($$renderer8) => {
                              $$renderer8.push(`<!---->`);
                              {
                                let child = function($$renderer9, { props }) {
                                  $$renderer9.push(`<a${attributes({ href: resolve(menu.url), ...props })}><!---->`);
                                  menu.icon($$renderer9, {});
                                  $$renderer9.push(`<!----> <span>${escape_html(menu.title)}</span></a>`);
                                };
                                Sidebar_menu_button($$renderer8, { child, $$slots: { child: true } });
                              }
                              $$renderer8.push(`<!---->`);
                            },
                            $$slots: { default: true }
...
function _layout($$renderer, $$props) {
  ...
  const menus = [
    ...
    { title: "追踪光线", url: "/tracingLight", icon: Inbox },
    { title: "拖拽", url: "/draggable", icon: Calendar }
  ];
